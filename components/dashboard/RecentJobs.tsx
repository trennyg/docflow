  ...
  if (jobs.length === 0) {
    return (
      <div className="bg-card border border-border rounded-xl p-8 text-center">
        ...
        <p className="text-text-muted text-sm">No extractions yet.</p>
        <Link href="/upload" className="mt-2 inline-block text-accent text-sm hover:underline">
  ...
  return (
    <div className="bg-card border border-border rounded-xl overflow-hidden">
      <div className="flex items-center justify-between px-5 py-3 border-b border-border">
        <h3 className="text-text-primary text-sm font-medium">Recent extractions</h3>
        <Link href="/jobs" className="text-accent text-xs hover:underline font-mono">
          View all →
        </Link>
      </div>
